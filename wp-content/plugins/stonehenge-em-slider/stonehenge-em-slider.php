...
Class Stonehenge_EM_Slider {
	...
	public static function register_assets() {
		...
		// Public assets only.
		wp_register_style('em-slider-css', plugins_url('assets/jquery.bxslider.min.css', __FILE__), '', $version, 'all');
		wp_register_script('em-slider-js', plugins_url('assets/jquery.bxslider.min.js', __FILE__), array('jquery'), $version, true);
	}
